...
CREATE TABLE `class_module` (
  ...
  PRIMARY KEY (`classname`,`modulename`),
  CONSTRAINT `class_module_ibfk_1` FOREIGN KEY (`classname`) REFERENCES `class` (`classname`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `student_ibfk_1` FOREIGN KEY (`classname`) REFERENCES `class` (`classname`),
...
INSERT INTO `user` VALUES ('admin',1,'$2a$08$rHyQc0p/VhPGHjtL.je2Ou3v7hj6QcVeGTeM5xuyD02qCl/aKeCvC');
...
-- Dump completed on 2021-11-28  0:43:21
